...
function Main() {
  const [vectorColor, setVectorColor] = useState('#2A4747');
  const location = useLocation();

  useEffect(() => {
    if (location.pathname === '/experience') {
      setVectorColor('#53A2BE');
    } else if (location.pathname === '/interests') {
      setVectorColor('#FFFFFF');
    } else if (location.pathname === '/which-cat-are-you') {
      setVectorColor('#84596B');
    } else {
      setVectorColor('#2A4747');
    }
  }, [location.pathname]);
  ...
  return (
    <>      
      ...
      <svg className="vector1" width="380" height="179" viewBox="0 0 380 179" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M3.21631 170.5C3.21631 133 3.21631 43.3421 3.21631 3.05245C36.1111 3.05245 4.80321 3.05243 40.7164 3.05243C78.8032 3.05243 91.1795 3.05247 129.216 3.05247C170.68 3.05247 174.375 3.05246 213.216 3.05246C236.375 3.05246 270.03 3.05251 354.216 3.05251C422.216 3.05251 318.36 92.1649 274.787 116.785C232.688 126.827 198.411 77.9356 155.43 66.9005C121.339 38.2985 3.21631 208 3.21631 170.5Z" fill={vectorColor} stroke="white" strokeWidth="5"/>
      </svg>
